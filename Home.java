...
public class Home extends JFrame {
    ...
    Home() {
        ...
        f3 = new Font("Calibri",Font.PLAIN,20);

        // Title
        label1 = new JLabel();
        label1.setText("Discover Your Next Adventure");
        label1.setBounds(120, 55, 530, 65);
        label1.setFont(f1);
        c.add(label1);
        ...
        label2.setBounds(270,190,250,20);
        label2.setFont(f3);
        c.add(label2);
