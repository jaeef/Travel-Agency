...
public class Registration extends JFrame {
    ...
    Registration() {
        ...
        // Fonts
        f1 = new Font("Calibri", Font.BOLD, 35);
        ...
        // Title
        label1 = new JLabel();
        label1.setText("Enter  Information To Register");
        label1.setBounds(270, 25, 600, 50);
        label1.setFont(f1);
        c.add(label1);
        ...
        label1.setBounds(50, 75, 520, 50);
        label1.setFont(f4);
        c.add(label1);

        tf1 = new JTextField();
        tf1.setBounds(240, 85, 550, 30);
        tf1.setFont(f5);
        c.add(tf1);
        ...
        label1.setBounds(50, 110, 500, 50);
        label1.setFont(f4);
        c.add(label1);

        tf2 = new JTextField();
        tf2.setBounds(240, 120, 550, 30);
        tf2.setFont(f5);
        c.add(tf2);
        ...
        label1.setBounds(50, 145, 500, 50);
        label1.setFont(f4);
        c.add(label1);

        tf3 = new JPasswordField();
        tf3.setBounds(240, 155, 550, 30);
        tf3.setFont(f2);
        tf3.setEchoChar('*');
        c.add(tf3);
        ...
        label1.setBounds(50, 180, 550, 50);
        label1.setFont(f4);
        c.add(label1);

        String[] secQsn = { "Enter a Security Question...", "Favourite Book Name?", "Favorite song?",
                "Do you Have a Laptop?", "Your Cgpa ?" };
        securityQsn = new JComboBox(secQsn);
        securityQsn.setBounds(240, 190, 550, 30);
        ...
        label1.setBounds(50, 215, 500, 50);
        label1.setFont(f4);
        c.add(label1);

        tf4 = new JTextField();
        tf4.setBounds(240, 225, 550, 30);
        tf4.setFont(f5);
        c.add(tf4);
        ...
        label1.setBounds(50, 250, 500, 50);
        label1.setFont(f4);
        c.add(label1);

        tf5 = new JTextField();
        tf5.setBounds(240, 260, 550, 30);
        tf5.setFont(f5);
        c.add(tf5);
        ...
        label1 = new JLabel();
        label1.setText(" " + a + " + " + b + " ");
        label1.setBounds(140, 260, 75, 30);
        label1.setFont(f4);
