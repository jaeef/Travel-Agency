...
public class DomesticCoxsBazar extends JFrame {
    ...
    DomesticCoxsBazar() {
        ...
        f3 = new Font("Calibri", Font.BOLD, 25);
        f4 = new Font("Segoe UI", Font.PLAIN, 20);
        f5 = new Font("Tahoma", Font.BOLD, 25);
        ...
        // Title
        label1 = new JLabel();
        label1.setText("Available Packs for Cox's Bazar");
