...
public class Payment extends JFrame {
    ...
    Payment() {
        ...
        logo = new ImageIcon(getClass().getResource("MasterCard.png"));
        imgLabel = new JLabel(logo);
        imgLabel.setBounds(280, 30, 250, 250);
        c.add(imgLabel);

        logo = new ImageIcon(getClass().getResource("VisaCard.png"));
        imgLabel = new JLabel(logo);
        imgLabel.setBounds(200, 30, 250, 250);
        c.add(imgLabel);
        logo = new ImageIcon(getClass().getResource("Amex.png"));
        imgLabel = new JLabel(logo);
        imgLabel.setBounds(360, 30, 250, 250);
        c.add(imgLabel);
        ...
        // Title
        label1 = new JLabel();
        label1.setText("Credit Card Payment");
        label1.setBounds(180, 45, 500, 50);
        label1.setFont(f1);
        c.add(label1);
        ...
        label3.setBounds(100, 180, 500, 50);
        label3.setFont(f3);
        c.add(label3);

        tf1 = new JTextField();
        tf1.setBounds(280, 190, 268, 30);
        tf1.setFont(f4);
        c.add(tf1);
        ...
        label3.setBounds(100, 260, 500, 50);
        label3.setFont(f3);
        c.add(label3);

        tf3 = new JTextField();
        tf3.setBounds(280, 270, 90, 30);
        tf3.setFont(f4);
        ...
        label3.setBounds(420, 260, 500, 50);
        label3.setFont(f3);
        c.add(label3);

        pf = new JPasswordField();
        pf.setBounds(470, 270, 80, 30);
        ...
        btn3.setBounds(340, 365, 270, 40);
        btn3.setFont(f6);
        btn3.setCursor(cursor);
        btn3.setForeground(Color.WHITE);
        btn3.setBackground(Color.decode("#28a745"));
        c.add(btn3);
